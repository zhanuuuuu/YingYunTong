...
public class Select_cStore_box_Pallet_point extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JSONArray array = Operation_update.Select_Box_Pallet_Position(
					GetConnection.getStoreConn(), fage,cStoreNo);
