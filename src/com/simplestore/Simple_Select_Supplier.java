...
@WebServlet(description = "查询供应商", urlPatterns = { "/Simple_Select_Supplier" })
public class Simple_Select_Supplier extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			JSONArray array = Select_Supplier(GetConnection.getStoreConn());
	...
	private JSONArray Select_Supplier(Connection conn) {
