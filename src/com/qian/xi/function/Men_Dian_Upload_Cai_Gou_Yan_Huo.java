...
@WebServlet(description = "门店提交采购验货单", urlPatterns = { "/Men_Dian_Upload_Cai_Gou_Yan_Huo" })
public class Men_Dian_Upload_Cai_Gou_Yan_Huo extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement past = conn.prepareStatement(
					"insert into WH_StockVerify(cStoreNo,cStoreName,dDate,cSheetNO,cSupplierNo,cSupplier,cOperatorNo,cOperator,cFillEmpNo,cFillEmp,dFillin,cFillinTime,cStockDptno,cStockDpt,fMoney,cWhNo,cWh,cTime,cSheetno_stock)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
