...
public class goods_Sale_Details extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			JSONArray array = report_table.Select_goods_Sale_Details(GetConnection.getStoreConn(), cGoods,date1, date2, storeno);
